...
/******************************************************************
函数名称：u16 LCD_BGR2RGB(u16 c)
功能说明：从ILI93xx读出的数据为GBR格式，而我们写入的时候为RGB格式。
          通过该函数转换。
输入函数：c:GBR格式的颜色值
输出函数：返回值：RGB格式的颜色值
******************************************************************/
...
/******************************************************************
函数名称：u16 LCD_ReadPoint(u16 x,u16 y)
功能说明：读取个某点的颜色值	
输入函数：x:0~239  y:0~319
输出函数：返回值:此点的颜色
******************************************************************/
u16 LCD_ReadPoint(u16 x,u16 y)
{
	...
	GPIOB->CRH=0X33333333; //PB8-15 上拉输出
	GPIOB->ODR=0XFFFF;    //全部输出高  
	if(DeviceCode==0X4531||DeviceCode==0X8989||DeviceCode==0XB505)return t;//这几种IC直接返回颜色值
...
/******************************************************************
函数名称：__inline void LCD_SetCursor(u16 Xpos, u16 Ypos)
功能说明：设置光标位置
...
/******************************************************************
函数名称：void LCD_DrawPoint(u16 x,u16 y)
功能说明：画点
输入参数：x:0~239  y:0~319	 POINT_COLOR:此点的颜色
输出参数：无
******************************************************************/
...
/******************************************************************
函数名称：void LCD_Fill(u16 xsta,u16 ysta,u16 xend,u16 yend,u16 color)
功能说明：在指定区域内填充指定颜色 
输入参数：区域大小: (xend-xsta)*(yend-ysta)
输出参数：无
******************************************************************/
...
/******************************************************************
函数名称：LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2)
功能说明：在指定位置画矩形
输入参数：x1，y1，x2，y2 坐标点
输出参数：无
******************************************************************/	
...
/******************************************************************
函数名称：void Draw_Circle(u16 x0,u16 y0,u8 r)
功能说明：在指定位置画一个指定大小的圆
输入参数：(x,y):中心点	 r    :半径
输出参数：无
******************************************************************/	   
...
/******************************************************************
函数名称：void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode)
功能说明：在指定位置显示一个字符
输入参数：x:0~234  y:0~308	 num:要显示的字符:" "--->"~"  
		  size:字体大小 12/16
...
/******************************************************************
函数名称：void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size)
功能说明：显示2个数字
输入参数：x,y:起点坐标 len :数字的位数 /size:字体大小  color:颜色
		  num:数值(0~4294967295);	 
输出参数：无
******************************************************************/
...
/******************************************************************
函数名称：void LCD_Show2Num(u16 x,u16 y,u16 num,u8 len,u8 size,u8 mode)
功能说明：显示2个数字
输入参数：x,y:起点坐标 size:字体大小   num:数值(0~99);
...
/******************************************************************
函数名称：void LCD_ShowString(u16 x,u16 y,const u8 *p)
功能说明：显示字符串，用16字体
